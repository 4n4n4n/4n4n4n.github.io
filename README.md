...
- **Teaching Assistant** for COMP2011 Programming with C++, HKUST
    ...
    - Designed assignment and answered questions from students
    - Designed a Go game programming assignment emphasizing recursion from scratch, assigned to approximately 400 students

- **Math Tutor** at MATH Support Centre, HKUST
...
- **Event Volunteer** for Culture Festival, School of Science, HKUST
    - Time: Mar 13, 2024
    - Helped with the Germany Counter for the Science School Culture Festival
